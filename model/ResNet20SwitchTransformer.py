...
class ResNet20TransformerBlock(nn.Module):
    def __init__(
        self,
        embed_dim,
        num_heads,
        ...
        super(ResNet20TransformerBlock, self).__init__()
...
class ResNet20SwitchTransformer(nn.Module):
    ...
    def __init__(
        ...
        super(ResNet20SwitchTransformer, self).__init__()
        ...
        self.backbone = ResNet20Backbone()
