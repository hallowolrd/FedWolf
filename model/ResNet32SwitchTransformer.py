...
class ResNet32Backbone(nn.Module):
    ...
    def __init__(self):
        ...
        self.stage1 = self._make_stage(16, 16, num_blocks=5, stride=1)
        self.stage2 = self._make_stage(16, 32, num_blocks=5, stride=2)
        self.stage3 = self._make_stage(32, 64, num_blocks=5, stride=2)
...
class TokenSwitchFFN(nn.Module):
    ...
    def forward(self, x):
        ...
        selected_counts = torch.bincount(flat_indices, minlength=self.num_experts).to(x.device)
...
class ResNet32TransformerBlock(nn.Module):
    def __init__(
        self,
        embed_dim,
        num_heads,
        ...
        super(ResNet32TransformerBlock, self).__init__()
...
class ResNet32SwitchTransformer(nn.Module):
    ...
    def __init__(
        ...
        super(ResNet32SwitchTransformer, self).__init__()
